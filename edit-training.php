...
<div class="mb-3" id="paidFields" style="display:none;">
  ...
  <?php if (!empty($tickets)): ?>
    <?php foreach ($tickets as $ticket): ?>
      ...
      <textarea class="mb-2 editor" name="ticket_benefits[]" placeholder="e.g. Certificate, Lunch, Materials"><?php echo htmlspecialchars($ticket['benefits']); ?></textarea>
...
$selected_subcategories = explode(',', $subcategory_id);
