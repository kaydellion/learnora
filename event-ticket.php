...
<body>
    <div class="ticket-container">
        ...
        <a href="download_ticket.php?order_id=<?php echo urlencode($order_id); ?>&training_id=<?php echo urlencode($training_id); ?>" class="btn btn-primary" target="_blank">Download as PDF</a>
    </div>
</body>
</html>