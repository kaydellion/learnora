...
if (isset($order_id)) {
  if ($pricing === 'free') {
    ...
    $sql = "SELECT COUNT(*) as count FROM {$siteprefix}order_items 
                WHERE training_id = '$training_id' AND order_id = '$order_id' AND item_id = 'free' LIMIT 12";
    ...
    $sql = "SELECT s FROM {$siteprefix}training_tickets WHERE training_id = '$training_id' LIMIT 12";
    ...
    $sql = "SELECT COUNT(DISTINCT item_id) as count FROM {$siteprefix}order_items 
                ...
                AND item_id IN ($ticket_ids_string) LIMIT 12";
    $result = mysqli_query($con, $sql);
    $row = mysqli_fetch_assoc($result);
      ...
      <div class="col-lg-6 mb-2 mb-lg-0" data-aos="fade-right" data-aos-delay="200">
        <div class="row">
          <div class="col-12">
                ...
                <div class="row mb-1">
                  <div class="col-6">
                    ...
                    <div class="user_info mb-1 d-flex">
                      <a href="<?php echo $siteurl . 'trainer-store?seller_id=' . $seller_id; ?>"><img
                          src="<?php echo $siteurl . $seller_photo; ?>" alt="<?php echo $seller_name; ?>"
                          class="user-image rounded-circle me-2" width="32" height="32"></a>
                    </div>
                  </div>
                  <div class="col-6">
                    ...
                    <div class="product-rating">
                      <div class="stars">
                        ...
                        ?>
                        <span
                          class="rating-value"><?php echo htmlspecialchars($average_rating, ENT_QUOTES, 'UTF-8'); ?></span>
                      </div>
                  ...
                  <div class="col-6">
                    ...
                    <div class="user_info mb-1 d-flex align-items-center instructor-click"
                      ...
                      <img src="<?php echo $siteurl . $instructor_picture; ?>" alt="<?php echo $instructor_name; ?>"
            ...
            $images = [];
            $sql = "SELECT picture FROM {$siteprefix}training_images WHERE training_id = ? LIMIT 12";
                ...
                <div class="image-zoom-container">
                  <?php if (!empty($images)): ?>
                    <a href="<?= htmlspecialchars($images[0]) ?>" class="glightbox" data-gallery="product-gallery">
                      <img src="<?= htmlspecialchars($images[0]) ?>" alt="Product Image"
                        class="img-fluid main-image drift-zoom" id="main-product-image"
                        data-zoom="<?= htmlspecialchars($images[0]) ?>">
          ...
          <div class="col-12">
              ...
              <div class="product-meta">
                ...
                <div class="product-price-container">
                  ...
                  <div class="mb-1">
                    ...
                    <?php endforeach; ?>
                    <?php if ($loyalty_id < 1): ?>
                      <h6>Buy for Less – <a href="<?php echo $siteurl; ?>loyalty-program.php">Sign up</a> as a loyalty
                        member today!</h6>
                      <div class="product-loyalty-container mb-3" style="display:none;">
                        <?php
                        $loyalty_query = "SELECT name, discount FROM {$siteprefix}subscription_plans WHERE status = 'active' LIMIT 12";
                    ...
                    <?php if ($pricing === 'paid'): ?>
                      <div class="mb-3">
                        ...
                        <div class="btn-group mb-1 flex-wrap" role="group" aria-label="Variation checkbox group">
                          <?php
                          $sql = "SELECT * FROM {$siteprefix}training_tickets WHERE training_id = '$training_id' ORDER BY price ASC LIMIT 12";
                          ...
                          while ($row = mysqli_fetch_array($sql2)) {
                            ...
                            <div class="m-1 position-relative">
                              <input type="checkbox" class="btn-check variation-checkbox" value="<?php echo $ticket_id; ?>"
                                name="variation_ids[]" id="ticket<?php echo $ticket_id; ?>"
                                data-price="<?php echo $amount; ?>" <?php if ($isSoldOut)
                                     echo 'disabled'; ?>
                                autocomplete="off">

                              <!-- Label with tooltip -->
                              <label class="btn btn-outline-<?php echo $isSoldOut ? 'secondary' : 'primary'; ?>"
                                for="ticket<?php echo $ticket_id; ?>" <?php if ($isSoldOut): ?>
                                  title="Ticket Sold Out. Please select another." <?php endif; ?>>
                              ...
                              <!-- JS output area -->
                              <div class="ticket-info mt-1 small text-muted" id="info-<?php echo $ticket_id; ?>"
            ...
            `;
                    ...
                    <?php else: ?>
                      <?php if ($pricing === 'paid' || $pricing === 'free'): ?>
                        ...
                        <?php else: ?>
                          ...
                          <input type="hidden" name="training_id" id="current_training_id"
                            value="<?php echo $training_id; ?>">
                          <button class="btn btn-primary add-to-cart-btn" data-report="<?php echo $training_id; ?>" name="add"
                            id="addCart">
                            <i class="bi bi-cart-plus"></i> Add to Cart
                          </button>
                        <?php endif; ?>
                      <?php elseif ($pricing === 'donation'): ?>
                        <button class="btn btn-primary donate-btn" type="button" id="donateBtn"
                          data-training-id="<?php echo $training_id; ?>" data-affiliate-id="<?php echo $affliate_id; ?>"
                      ...
                      <button
                        class="btn btn-outline-secondary wishlist-btn<?php echo $theinitialicon ? ' ' . $theinitialicon : ''; ?>"
                        data-product-id="<?php echo $training_id; ?>" aria-label="Add to wishlist">
                  ...
                  <div class="inhouse-proposal my-3 p-3 border rounded bg-light">
                    ...
                    <p class="mb-1">
                      Interested in hosting this training & event at your organization? Let us know if you’d like to
                      arrange a customized in-house session for your team.
                    </p>
                    <a href="<?php echo $siteurl; ?>inhouse-proposal.php?training_id=<?php echo $training_id; ?>"
                  ...
                  <div>
                    ...
                    <a href="<?php echo $siteurl; ?>attendees.php?training_id=<?php echo $training_id; ?>"
      ...
      <div class="col-12 mb-3" data-aos="fade-left" data-aos-delay="300">
        <div class="card shadow-sm">
          <div class="card-body">
            <!-- Nav tabs -->
            <style>
              .nav-tabs.tabb .nav-link {
                padding: 0.25rem 0.5rem;
                font-size: 0.8rem;
                white-space: nowrap;
                min-width: auto;
              }
              .nav-tabs.tabb .nav-item {
                margin-bottom: 0;
              }
            </style>
            <ul class="nav nav-tabs tabb mb-3" id="courseTab" role="tablist">
              ...
              <?php if (!empty(trim($target_audience))): ?>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="audience-tab" data-bs-toggle="tab" data-bs-target="#audience" type="button"
                    role="tab" aria-controls="audience" aria-selected="false">
                    Target Audience
                  </button>
                </li>
              <?php endif; ?>
              ...
              <?php if (!empty($course_requirrement)): ?>
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="requirements-tab" data-bs-toggle="tab" data-bs-target="#requirements"
                    type="button" role="tab" aria-controls="requirements" aria-selected="false">
                    Course Requirements
                  </button>
                </li>
              <?php endif; ?>
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="visa-requirements-tab" data-bs-toggle="tab"
                  data-bs-target="#visa-requirements" type="button" role="tab" aria-controls="review"
                  aria-selected="false">
                  Visa Requirement
                </button>
              </li>
              ...
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="cancellation-policy-tab" data-bs-toggle="tab"
                  data-bs-target="#cancellation-policy" type="button" role="tab" aria-controls="cancellation-policy"
                  aria-selected="false">
                  Cancellation Policy
                </button>
              </li>
                      ...
                      <div class="accordion-item">
                        <h2 class="accordion-header" id="headingBenefit">
                          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapseBenefit" aria-expanded="false" aria-controls="collapseBenefit">
                            Course Description
                          </button>
                        </h2>
                        <div id="collapseBenefit" class="accordion-collapse collapse show"
                          aria-labelledby="headingBenefit" data-bs-parent="#benefitAccordion">
              ...
              <div class="tab-pane fade" id="requirements" role="tabpanel" aria-labelledby="requirements-tab">
                <div class="product-description mb-1">
                  <?php if (!empty($course_requirrement)): ?>
                    ...
                    ?>
                  <?php else: ?>
                    <p>No course requirements available.</p>
                  <?php endif; ?>
                </div>
              </div>
...
Participants attending training sessions abroad will need to obtain a visa independently. Learnora (Kyneli Business Support Services) does not process visas on behalf of trainees. Please contact the appropriate embassy for visa requirements specific to your destination country.';
                  ...
                  ?>
                  <p>
                    <span class="short-desc"><?php echo $visa_short; ?><?php if ($visa_is_long)
                         echo '...'; ?></span>
                    <?php if ($visa_is_long): ?>
                      <span class="full-desc" style="display:none;"><?php echo $visa_long; ?></span>
                      <br>
                      <button type="button" class="btn btn-link btn-sm p-0 read-more-btn"
                        style="text-decoration: none;">Read More</button>
                      <button type="button" class="btn btn-link btn-sm p-0 read-less-btn"
                        style="text-decoration: none; display:none;">Read Less</button>
                    <?php endif; ?>
                  </p>
                </div>

              </div>
              <div class="tab-pane fade" id="cancellation-policy" role="tabpanel"
                aria-labelledby="cancellation-policy-tab">
                <div class="collapsible-section">
                  ...
                  <p>
                    <span
                      class="short-desc"><?php echo $cancel_short; ?><?php if ($cancel_is_long)
                           echo '...'; ?></span>
                  ...
                  <?php if (!empty($training_video)): ?>
                    <div class="accordion mb-3" id="videoAccordion">
                      <div class="accordion-item">
                        ...
                        <div id="collapseVideo" class="accordion-collapse collapse show" aria-labelledby="headingVideo"
                  ...
                  <div class="product-details-accordion">
                    ...
                    <div class="accordion-item" id="reviews">
                      <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                          data-bs-target="#reviewsContent" aria-expanded="true" aria-controls="reviewsContent">
                          Write a Review
                        </button>
                      </h2>
                            ...
                            <div class="review-form-container mt-5">
                              ...
                              <form class="review-form" method="POST">
                                ...
                                <div class="mb-4">
                                  ...
                                  <textarea class="form-control" id="review-content" rows="4" name="review"
                                    required=""></textarea>

                                </div>

                                <div class="d-grid">
                                  <button type="submit" name="submit-review" class="btn btn-primary">Submit
                                    Review</button>
                                </div>
                              </form>
                            </div>
                    ...
                    <?php if (!empty($all_reviews)): ?>
                      <div class="accordion-item">
                        <h2 class="accordion-header">
                          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#reviewssummary" aria-expanded="false" aria-controls="reviewssummary">
                            All Reviews
                          </button>
                        </h2>
                                  ...
                                  <div class="col-lg-4">
                                    <div class="overall-rating">
                                      ...
                                      <div class="rating-count">
                                        Based on <?php echo (int) $review_count; ?>
                                ...
                                <div class="review-item mb-4" style="<?php echo $i > 2 ? 'display:none;' : ''; ?>">
                                  <div class="review-header d-flex justify-content-between align-items-center">
                                    <div class="reviewer-info d-flex align-items-center">
                                      <div>
                                        <h5 class="reviewer-name mb-0"><?php echo htmlspecialchars($review['user_name']); ?>
                                        </h5>
                                        <div class="review-date"><?php echo date('m/d/Y', strtotime($review['date'])); ?>
                                        </div>
                                      </div>
                                    </div>
...
<section id="best-sellers" class="best-sellers section">
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    <div class="section-title text-center mb-4">
      ...
      <p>Explore the latest training programs our learners are signing up for. Stay ahead with trending and in-demand
        courses!</p>
    </div>
...
<div class="modal fade" id="reportProductModal" tabindex="-1" aria-labelledby="reportProductModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
