    ...
    <section id="best-sellers" class="best-sellers section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-4">
          <!-- Product 1 -->
          <?php
$query = "SELECT t.*, u.name AS display_name, tt.price, u.photo AS profile_picture, l.category_name AS category,
 sc.category_name AS subcategory, ti.picture FROM {$siteprefix}training t 
 ...
 INNER JOIN {$siteprefix}training_event_dates ted ON t.training_id = ted.training_id 
 WHERE t.status = 'approved' AND CONCAT(ted.event_date, ' ', ted.start_time) >= NOW() 
 GROUP BY t.training_id ORDER BY t.training_id DESC LIMIT 20";
